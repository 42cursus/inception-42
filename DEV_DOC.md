...
- `/home/abelov/data/mariadb`: Database files
- `/home/abelov/data/wordpress`: WordPress site files
...
- `make fclean`: **WARNING** - Deletes all containers, images, AND data in `/home/abelov/data`.
